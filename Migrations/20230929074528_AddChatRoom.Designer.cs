...
namespace TestFinal.Migrations
{
    ...
    [Migration("20230929074528_AddChatRoom")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TestFinal.Models.ChatRoom", b =>
                {
            ...
            modelBuilder.Entity("TestFinal.Models.Message", b =>
                {
                    ...
                    b.Property<int>("MessagesReciverId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MessagesReciverId");

                    b.HasIndex("MessagesSenderId");
            ...
            modelBuilder.Entity("TestFinal.Models.RoomMessage", b =>
                {
            ...
            modelBuilder.Entity("TestFinal.Models.UserChatRoom", b =>
                {
            ...
            modelBuilder.Entity("TestFinal.Models.Message", b =>
                {
                    b.HasOne("TestFinal.Models.User", "MessagesReciver")
                        .WithMany("MessagesReciver")
                        .HasForeignKey("MessagesReciverId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TestFinal.Models.User", "MessagesSender")
                        .WithMany("MessagesSender")
                        .HasForeignKey("MessagesSenderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("MessagesReciver");
            ...
            modelBuilder.Entity("TestFinal.Models.RoomMessage", b =>
                {
                    b.HasOne("TestFinal.Models.ChatRoom", "ChatRoom")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("TestFinal.Models.UserChatRoom", b =>
                {
                    b.HasOne("TestFinal.Models.User", "ChatMember")
